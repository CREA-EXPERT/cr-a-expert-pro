...
export const CONSULTATION_TEXTES_VERSION = "2026-08-15.3";

export const CONSULTATION_TITRE = "Besoin d'un avis sur votre situation ?";

/** Durée de référence — jamais exprimée en minutes. */
export const CONSULTATION_DUREE =
  "Consultation d'1 heure avec un expert-comptable.";
...
export const CONSULTATION_SOUS_BOUTON =
  `Consultation d' 1h avec un expert-comptable. ${PRIX_CONSULTATION.ttc} TTC ( ${PRIX_CONSULTATION.tva}). La durée est indicative, on traite le problème jusqu'au bout.`;
